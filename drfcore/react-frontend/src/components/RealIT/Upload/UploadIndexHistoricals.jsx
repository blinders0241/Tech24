...
function UploadIndexHistoricals() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        allNotesapi + "uploadIndexHistoricals/",
        formData,
        {
          params: {
            indexName: index, // replace 'paramName' and 'paramValue' with your parameter name and value
          },
        }
      );
  ...
  return (
    <>
      <Container>
        <Row>
          <Col md={6}>
            <h1>Upload Index Historical Data </h1>
            ...
            <Button variant="danger" onClick={handleIndexName}>
              SetIndexNameBANK
            </Button>
          </Col>
          <Col md={6}>
...
export default UploadIndexHistoricals;
